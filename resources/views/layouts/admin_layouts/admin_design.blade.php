...
<head>
  ...
  <title>BRGY NBBS | Dashboard</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="icon" type="image/png" sizes="96x96" href="{{url('images/admin_images/logo.jpg')}}">
  <!-- Font Awesome -->
...
<!-- script autocomplete -->
<script src="{{ url('jquery-ui/jquery-ui.min.js') }}" type='text/javascript'></script>
